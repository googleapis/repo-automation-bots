...
/**
 * The DiscoveryDocUpdate class's checkPR function returns
 * true if the PR:
  - has an author that is 'googleapis-publisher'
  - has a title that starts with 'chore: autogenerated discovery document update'
 */
export class DiscoveryDocUpdate extends BaseLanguageRule {
  classRule = {
