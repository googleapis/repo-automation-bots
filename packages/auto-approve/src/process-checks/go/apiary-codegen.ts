...
/**
 * The GoApiaryCodegen class's checkPR function returns
 * true if the PR:
   - author is 'yoshi-automation'
   - title of the PR matches the regexp: /^feat\(all\): auto-regenerate discovery clients$/
 */
export class GoApiaryCodegen extends BaseLanguageRule {
  classRule = {
    author: 'yoshi-automation',
    titleRegex: /^feat\(all\): auto-regenerate discovery clients$/,
  };
