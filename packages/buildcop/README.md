...
> A GitHub App built with [Probot](https://github.com/probot/probot) creates
issues for failing builds, and closes issues if builds start workign again.

## Usage

Listens for failing kokoro builds, and curates issues on GitHub corresponding
to them.
