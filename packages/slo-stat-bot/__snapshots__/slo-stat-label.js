...
exports[
  'slo-status-label handleSLOs is triggered An error comment and failure check is made on PR if issue_slo_rules lint is not valid 1'
] = {
  body: 'ERROR: "issue_slo_rules.json" file is not valid with JSON schema',
};

exports[
  'slo-status-label handleSLOs is triggered An error comment and failure check is made on PR if issue_slo_rules lint is not valid 2'
] = {
...
exports[
  'slo-status-label handleSLOs is triggered Leaves no comment on PR and sets success check if issue_slo_rules lint is valid 1'
] = {
  name: 'slo-rules-check',
  head_sha: 'c5b0c82f5d58dd4a87e4e3e5f73cd752e552931a',
  conclusion: 'success',
...
exports[
  'slo-status-label Checking for compliant settings given a slo applies to an issue repo level file exists with write contributer being valid responder Returns false and creates and adds label OOSLO to issue if no valid responder was assigned 1'
] = {
  name: 'OOSLO',
  color: 'ff6f6f',
  description: 'Issue is out of slo',
...
exports[
  'slo-status-label Checking for compliant settings given a slo applies to an issue repo level file exists with write contributer being valid responder Returns false and creates and adds label OOSLO to issue if no valid responder was assigned 2'
] = {
  labels: ['OOSLO'],
};

exports[
  'slo-status-label Checking for compliant settings given a slo applies to an issue repo level file exists with write contributer being valid responder Returns false if no valid responder commented and does not relabel OOSLO if it already exists in issue 1'
] = {
  labels: ['OOSLO'],
};

exports[
  'slo-status-label handleSLOs is triggered Error is logged if commenting on PR fails 1'
] = {
  body: 'ERROR: "issue_slo_rules.json" file is not valid with JSON schema',
};

exports[
  'slo-status-label handleSLOs is triggered Error is logged if creating check on PR fails 1'
] = {
  body: 'ERROR: "issue_slo_rules.json" file is not valid with JSON schema',
};

exports[
  'slo-status-label handleSLOs is triggered Error is logged if creating check on PR fails 2'
] = {
  name: 'slo-rules-check',
  head_sha: 'c5b0c82f5d58dd4a87e4e3e5f73cd752e552931a',
  conclusion: 'failure',
