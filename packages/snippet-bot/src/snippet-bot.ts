...
If you find problems with this result, please file an issue at:
https://github.com/googleapis/repo-automation-bots/issues.
To update this comment, add \`${REFRESH_LABEL}\` label or use the checkbox:
...
// This should synced with the body of the comment. When we move
// `onRefreshCheckbox` to gcf-utils, we can have the single source and
// automatically add the checkbox in `addOrUpdateIssueComment`.
const REFRESH_STRING = '- [x] Refresh this comment';

function onRefreshCheckbox(
  app: Application,
  ...
  app.on('issue_comment.edited', async context => {
    ...
    // This should be synced with gcf-utils
    const commentMark = `<!-- probot comment [${installationId}]-->`;
...
export = (app: Application) => {
  onRefreshCheckbox(app, async context => {
    ...
    logger.info({prResponse: prResponse});
