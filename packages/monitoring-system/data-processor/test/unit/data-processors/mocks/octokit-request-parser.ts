...
/**
 * NOTE: This file is duplicated in gcf-utils/src but cannot be imported
 * from there since it's not part of the same root directory
 * TODO(asonawalla): Publish gcf-utils/src/octokit-request-parser as a separate
