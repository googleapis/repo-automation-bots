...
exports['common utils tests opens a PR against the main branch 1'] = {
  head: 'specialName',
  base: 'main',
  title: 'feat: add initial files for .github/.Owlbot.yaml',
  body: '- [x] Regenerate this pull request now.\nCopy-Tag:\neyJwIjoiZ29vZ2xlLmNsb3VkLmttcy52MSIsImgiOiI2ZGNiMDliNWI1Nzg3NWYzMzRmNjFhZWJlZDY5NWUyZTQxOTNkYjVlIn0=',
};
