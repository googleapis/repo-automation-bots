    ...
    it.skip('merges a PR on green', async () => {
      ...
      function getReviewsCompleted() {
        ...
        .reply(200, {
            ...
            "state": "APPROVED",
            "html_url": "https://github.com/testRepo/testOwner/pull/1#pullrequestreview-80",
            "pull_request_url": "https://api.github.com/repos/octocat/Hello-World/pulls/12",
            "_links": {
              "html": {
                "href": "https://github.com/testRepo/Hello-World/pull/1#pullrequestreview-80"
              },
              "pull_request": {
                "href": "https://api.github.com/repos/testRepo/testOwner/pulls/1"
              }
            }
          }
        ) }
       ...
       function getLatestCommit() {
        ...
        function getStatusi() {
          ...
          get('/repos/testOwner/testRepo/commits/6dcb09b5b57875f334f61aebed695e2e4193db5e/statuses').
          reply(200, 
            {
        ...
        return [ 
          {
            ...
            "commit_id": "6dcb09b5b57875f334f61aebed695e2e4193db5e",
            "state": "APPROVED",
            "html_url": "https://github.com/testRepo/testOwnrt/pull/1#pullrequestreview-80",
            "pull_request_url": "https://api.github.com/repos/octocat/Hello-World/pulls/12",
            "_links": {
              "html": {
