exports['merge-on-green responds to pull requests gets branch information when a pull request is opened, responds with a failed status check for no branch protection 1'] = {
...
exports['merge-on-green responds to pull requests gets branch information when a pull request is opened, responds with a passed status check 1'] = {
  "name": "merge-on-green-readiness",
  "conclusion": "success",
  "head_sha": "6dcb09b5b57875f334f61aebed695e2e4193db5e"
}

exports['merge-on-green responds to pull requests gets branch information when a pull request is opened, responds with a failed status check because branch protection does not match config 1'] = {
  "head_sha": "6dcb09b5b57875f334f61aebed695e2e4193db5e",
  "name": "merge-on-green-readiness",
  "conclusion": "failure",
  "output": {
...
exports['merge-on-green responds to pull requests gets branch information when a pull request is opened, responds with a failed status check because there are less than 3 tests 1'] = {
  "head_sha": "6dcb09b5b57875f334f61aebed695e2e4193db5e",
  "name": "merge-on-green-readiness",
  "conclusion": "failure",
  "output": {
