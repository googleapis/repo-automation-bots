...
import * as handler from '../../src/code-suggester/github/commit-and-push';
import * as createCommitModule from '../../src/code-suggester/github/create-commit';
import {
  Changes,
  FileData,
  TreeObject,
  ...
  CommitData,
  CommitSigner,
} from '../../src/code-suggester/types';
import {createCommit} from '../../src/code-suggester/github/create-commit';
import {CommitError} from '../../src/code-suggester/errors';

import commitResponseData from '../fixtures/get-commit-response.json';
import createTreeResponseData from '../fixtures/create-tree-response.json';
import createCommitResponseData from '../fixtures/create-commit-response.json';
...
describe('Push', () => {
  ...
  it('Calls octokit functions with correct params', async () => {
    ...
    const getCommitResponse: GetCommitResponse = {
      headers: {},
      status: 200,
      url: 'http://fake-url.com',
      data: commitResponseData as unknown as GetCommitResponse['data'],
    };
    const createTreeResponse: CreateTreeResponse = {
      headers: {},
      status: 201,
      url: 'http://fake-url.com',
      data: createTreeResponseData as unknown as CreateTreeResponse['data'],
    };
    // setup
...
describe('Commit', () => {
  ...
  it('Invokes octokit function called with correct values', async () => {
    // setup
    const createCommitResponse: CreateCommitResponse = {
      headers: {},
      status: 201,
      url: 'http://fake-url.com',
      data: createCommitResponseData as unknown as CreateCommitResponse['data'],
    };
